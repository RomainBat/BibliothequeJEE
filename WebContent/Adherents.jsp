<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="biblipackage.OperationCollec.Operation, biblipackage.UtilisateurCollec.Utilisateur, biblipackage.LivreCollec.Livre" %>
<%
String userId = null;
	...
	for(int i = 0; i<reservations.length; i++){
		...
		<li class="reservation">
			...
			<form action="Site?page=Adherents" method="POST">
				...
				<input type="hidden" name="type_operation" value="emprunt"/>
